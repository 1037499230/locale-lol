...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  selectSpreadsheetFile: () => ipcRenderer.invoke('select-spreadsheet-file'),
  getSpreadsheetMetadata: (filePath) => ipcRenderer.invoke('get-spreadsheet-metadata', filePath),
  readSpreadsheetSheet: (filePath, sheetName) => ipcRenderer.invoke('read-spreadsheet-sheet', filePath, sheetName),
  ...
  batchAddLocalePc: (dirPath, excludePattern, targetProperty, objectsToAdd, type, strictTranslations) => ipcRenderer.invoke('batch-add-locale-pc', dirPath, excludePattern, targetProperty, objectsToAdd, type, strictTranslations),
  batchAddLocaleAdmin: (localesPath, targetProperty, objectsToAdd, type, strictTranslations) => ipcRenderer.invoke('batch-add-locale-admin', localesPath, targetProperty, objectsToAdd, type, strictTranslations),
